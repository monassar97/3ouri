...
class Confirmingaddingaservice extends StatelessWidget {
  Confirmingaddingaservice({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(15.0, 114.0, 306.0, 42.0),
                    size: Size(335.0, 229.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                    child: Text(
                      'Your request to apply for a service has been\nsent to the admin successfully.',
                      style: TextStyle(
                        fontFamily: 'Lato',
                        fontSize: 16,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(39.0, 176.0, 258.0, 19.0),
                    size: Size(335.0, 229.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(145.0, 40.8, 45.2, 45.2),
                    size: Size(335.0, 229.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
