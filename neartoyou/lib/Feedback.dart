            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(63.2, 13.0, 36.0, 19.0),
                    size: Size(162.5, 45.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 1.0, color: const Color(0xff00574d)),
                      ),
                    ),
                  ),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(57.2, 13.0, 48.0, 19.0),
                    size: Size(162.5, 45.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(20.0, 42.0, 147.0, 17.0),
                    size: Size(335.0, 69.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 335.0, 188.0),
                    size: Size(335.0, 188.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 29.0, 335.0, 159.0),
                          size: Size(335.0, 188.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(20.0, 42.0, 179.0, 17.0),
                    size: Size(335.0, 188.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
