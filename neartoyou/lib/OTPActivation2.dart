...
class OTPActivation2 extends StatelessWidget {
  OTPActivation2({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 375.0, 598.0),
                    size: Size(375.0, 598.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(102.0, 13.0, 92.0, 19.0),
                      size: Size(295.0, 45.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 65.0, 60.0),
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: const Color(0xffffffff),
                        border: Border.all(
                            width: 1.0, color: const Color(0xff8bac21)),
                      ),
                    ),
                  ),
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(154.0, 0.0, 63.0, 60.0),
                    size: Size(295.0, 60.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(77.0, 0.0, 63.0, 60.0),
                    size: Size(295.0, 60.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(229.0, 0.0, 66.0, 60.0),
                    size: Size(295.0, 60.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
