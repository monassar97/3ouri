...
import './ChooselanguageSelected1.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Chooselanguage2 extends StatelessWidget {
  Chooselanguage2({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 134.0, 76.0),
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(115.0, 21.0, 50.0, 19.0),
                    size: Size(375.0, 60.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => ChooselanguageSelected1(),
                ),
              ],
              child: SizedBox(
                width: 375.0,
...
const String _svg_lgppwm =
    '<svg viewBox="0.5 363.5 375.0 61.0" ><path transform="translate(0.5, 363.5)" d="M 0 0 L 375 0" fill="none" stroke="#cbd3b4" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(0.5, 424.5)" d="M 0 0 L 375 0" fill="none" stroke="#cbd3b4" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
