...
import './PredefinedservicesSelected.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Predefinedservices extends StatelessWidget {
  Predefinedservices({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                    ...
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ...
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => PredefinedservicesSelected(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 531.0, 157.0, 157.0),
                    size: Size(334.0, 688.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
